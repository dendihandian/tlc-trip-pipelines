"""
docker-compose exec tlc_pipelines python pipelines/raw/yellow_tripdata/pipeline.py incremental
docker-compose exec tlc_pipelines python pipelines/raw/yellow_tripdata/pipeline.py backfill --start-date 2026-03-01 --end-date 2026-03-01
"""
...
from utils.db import save_to_postgresql, execute_query
...
def process_by_date(date: str):
    ...
    query = query.replace('{query_filter}', f"DATE(tpep_pickup_datetime) = DATE('{date}')")
